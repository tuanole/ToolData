		...
		<div class="col-md-4" style="border:1px solid black;">
			<p style="text-align:center;font-size:20px;"><b>Đơn Vị Trả</b></p>
			 <div class="row">
				<div class="col-md-2"></div>
				<div class="col-md-8">
					<select class="select2" required  style="width: 100%;text-align:center;" id="selectBaseOut">
					  <option value="">Chọn...</option>
					   <c:forEach items="${bases}" var="base">
	...
	<div class="row" style="margin-top:20px">
		<div class="col-md-5">
			...
			<div class="row">
				...
				<div class="col-md-7">
					<select class="select2" required style="width: 50%;overflow:auto;height: 25px;" id="selectType">
			...
			<br/>
			<div class="row">
				<div class="col-md-3" style="text-align:right;font-size: 15px;"><p>XIÊN:</p></div>   
				<div class="col-md-7">
					<textarea rows="3" cols="43.5" name="usrtxt" wrap="hard" placeholder="Nhập số liệu xiên!" id="stringXien"></textarea>
				</div>
			</div>
			<br/>
			<div class="row">
...
<script>
	$( document ).ready(function() {
		...
		$("#genXien").on("click", function(e){
			$("#myTable tbody").empty();
			var stringXien = $('#stringXien').val();
			var cus = $('#uid').val();
			...
			if(baseIn == ""){
				...
				$.ajax({
					type : "GET",
					url : '/calculationXien?stringXien=' + stringXien + '&type=' + type + '&baseIn=' + baseIn + '&baseOut=' + baseOut,
					dataType: "json",
		...
		$("#submit").on("click", function(e){
			...
			var baseOut = $('#selectBaseOut').val();
	         ...
	         $("#myTable TBODY TR").each(function () {
	             ...
	             customer.user = row.find("TD").eq(4).html();
	             customers.push(customer);
	         });

        	 $.ajax({
 	        	type : "POST",
 	            url: '/saveXien?baseIn=' + baseIn + '&baseOut=' + baseOut + '&type=' + type,
